    ...
    <script>
        ...
        function initializeTour(data) {
            data.scenes.forEach(scene => {
                scene.infoHotspots = scene.infoHotspots.filter(hotspot => hotspot.text.trim() !== '');
            });

            console.log(data); // For demonstration purposes, log the modified data
            // Here you would initialize your virtual tour using the modified data.
            // Example: initVirtualTour(data);
        }

        document.addEventListener('DOMContentLoaded', function() {
            initializeTour(APP_DATA);
        });
    </script>
</body>
</html>
